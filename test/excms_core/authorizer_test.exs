defmodule ExcmsCore.AuthorizerTest do
  ...
  defp can?(user, action, resource_or_module) do
    Authorizer.can?(user, action, resource_or_module, SimpleAdminAuthorizer)
  end

  defp can_all(user, action, resource_module) do
    Authorizer.can_all(user, action, resource_module, SimpleAdminAuthorizer)
  end

  defp can_actions(user, resource_or_module) do
    Authorizer.can_actions(user, resource_or_module, SimpleAdminAuthorizer)
  end
