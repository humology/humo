defmodule ExcmsCore.WarehouseTest do
  use ExUnit.Case
  ...
  describe "resource_helpers/1" do
    test "returns schema name from provided resource" do
      assert "excms_core_pages" = Warehouse.resource_helpers(Page).name()
    end
  end

  describe "names_resources/0" do
    test "returns map of resource names to resource modules" do
      assert %{"excms_core_pages" => Page} = Warehouse.names_resources()
    end
  end
  ...
  describe "validate_config/1" do
    test "name/0 is not exported" do
      ...
      expected_message =
        """
        Application: :app
        ExcmsCore.WarehouseTest.Page1.Helpers expected exported function name/0
        """
    ...
    test "resource name expected to start with prefix \"app_\"" do
      ...
      expected_message =
        """
        Application: :app
        ExcmsCore.WarehouseTest.Page2.Helpers.name() expected to start with "app_", actual: "pages"
        """
    ...
    test "actions/0 is not exported" do
      ...
      expected_message =
        """
        Application: :app
        ExcmsCore.WarehouseTest.Page3.Helpers expected exported function actions/0
        """
    ...
    test "actions/0 cannot be empty" do
      ...
      expected_message =
        """
        Application: :app
        ExcmsCore.WarehouseTest.Page4.Helpers.actions() cannot be empty
        """
    ...
    test "actions/0 action type is not binary" do
      ...
      expected_message =
        """
        Application: :app
        ExcmsCore.WarehouseTest.Page5.Helpers action :update type expected to be binary
        """
