defmodule Humo.Authorizer.Behaviour do
  defmacro __using__(_opts) do
    quote do
      alias Humo.Authorizer.Behaviour
      ...
      """
      @impl Humo.Authorizer.Behaviour
  ...
  @type resource_module() :: Humo.Warehouse.resource_module()
